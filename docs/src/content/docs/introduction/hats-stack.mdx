...
The HATS Stack is intentionally opinionated — designed to combine modern web tools into a **fast**, **powerful**, and **secure** way to build applications using Razor Pages and MVC.

<CardGrid>
  <Card title="HTMX" icon="rocket">
    A JS library that allows any HTML element to make AJAX requests using HTML attributes. Load portions of a page incrementally instead of refreshing the entire document.
  </Card>
  <Card title="AlpineJS" icon="star">
    Declarative HTML attributes for web interactivity, events, and DOM manipulation — without an imperative approach like JQuery or vanilla JS.
  </Card>
  <Card title="TailwindCSS" icon="seti:css">
    Utility-first CSS framework beloved by backend developers. The most easily replaceable part of the stack — use whichever CSS library you prefer.
  </Card>
  <Card title="Static Components" icon="puzzle">
    The glue that makes the other tools synergize. Component-driven UI composition built on top of ASP.NET Core Tag Helpers.
  </Card>
</CardGrid>
...
Khalid Abuhakmeh is the writer of an amazing [ASP.NET Core library](https://github.com/khalidabuhakmeh/Htmx.Net) that makes it easier to write forms powered by HTMX and it is an important component of this stack, especially for convenience and ergonomics.
